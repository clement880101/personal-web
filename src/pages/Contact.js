        ...
        flexDirection={(vheight + 200> vwidth) ? "column":"row"}>
            <Box sx={{ minWidth:"50vw", marginTop:7}}>
                ...
                <Box sx={{display:"flex", flexDirection:"row", width:"100%", justifyContent:"space-evenly"}}>
                    ...
                    whileHover={{y:[0, -3], transition:{duration:0.1}}}
                ...
                <Box sx={{display:"flex", flexDirection:"column", padding:2}}>
                    ...
                    <TextField size="small" sx={{width:400, marginY:1}} label="Message Title" variant="outlined" required/>
                    <TextField size="small" sx={{marginY:1}} label="Message Content" variant="outlined" required 
                    multiline rows={3}/>
                    <IconButton sx={{alignSelf:"end"}} disableRipple>
            ...
            <Map
                ...
                dprs={[1, 2]}
                height={(vheight + 200 > vwidth) ? vheight/2 : vheight}
                width={(vheight + 200> vwidth) ? vwidth : vwidth/2}
                defaultCenter={[37.5, -122.2]}
                defaultZoom={10}
            >
                <Overlay anchor={[37.389, -122.081]} offset={[20, 30]} style={{display:"flex", flexDirection:"row"}}>
                    <PushPinIcon fontSize="large" style={{color:"black"}}/>
