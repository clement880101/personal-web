    ...
    return (
        <Box sx={{
            ...
            <Head>
                ...
                <meta name="description" content="404 in clementc.dev"/>
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:domain" content="clementc.dev" />
                <meta property="twitter:url" content="https://clementc.dev/404" />
                <meta name="twitter:title" content="404 | clementc.dev" />
                <meta name="twitter:description" content="404 in clementc.dev" />
            ...
            <Button variant="contained" size="small" disableTouchRipple sx={{ borderRadius: 10, margin: 1 }}
                onClick={() => { router.replace("/home") }}>Home</Button>
        </Box>
    )
}